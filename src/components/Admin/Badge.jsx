...
export default function Badge({ label }) {
  const map = {
    ...
    Draft: s.badgeAmber, Expiring: s.badgeAmber, Pending: s.badgeAmber, 'No Plan': s.badgeAmber, Upcoming: s.badgeAmber, 'Plan-Specific': s.badgeAmber, 'Follow up': s.badgeAmber, 'Follow Up': s.badgeAmber, absent: s.badgeAmber,
    ...
    Missed: s.badgeRed, 'Pending Attendance': s.badgeAmber, Rescheduled: s.badgeBlue, Scheduled: s.badgeAmber, 'Live Now': s.badgeGreen, Awaiting: s.badgeAmber,
  };
