...
export const register = asyncHandler(async (req, res) => {
  ...
  const welcomeMessage = autoGenerated
    ? `Hello ${name},<br><br>An administrator created your SomaWellness account.<br><strong>Email:</strong> ${user.email}<br><strong>Temporary Password:</strong> ${raw}<br><br>Please log in and change your password.`
  ...
  notificationService
    .send(user._id, {
      ...
      subject: autoGenerated
        ? "Your SomaWellness Account Credentials"
        : `Welcome to SomaWellness, ${user.name}!`,
...
export const updateProfile = asyncHandler(async (req, res) => {
  ...
  // Staff (admin/manager/reception) must get their user record back so the
  // client keeps role + permissions. Only students get the aggregated dashboard.
  if (req.user.role === "admin" || req.user.role === "manager" || req.user.role === "reception") {
    const fresh = await User.findById(req.user._id);
    return res.json(publicUser(fresh));
  }
