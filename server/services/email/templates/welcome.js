...
export default function render(data = {}) {
  const name = escapeHtml(data.name || 'Wellness Seeker');
  ...
  const body = `
    ...
    ${p(`Welcome to <strong>${STUDIO_NAME}</strong> — your journey toward holistic wellness and mindfulness begins today.`)}
  ...
  const text = [
    `Namaste ${name},`,
    '',
    `Welcome to ${STUDIO_NAME} — your journey toward holistic wellness and mindfulness begins today.`,
