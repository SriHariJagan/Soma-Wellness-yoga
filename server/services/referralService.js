    ...
    if (referrerUser?.email) {
      await emailService.sendMail(
        ...
        `<h2 style="color:#2D1406;">Referral Reward!</h2>
         ...
         <p>Your friend <strong>${newUser.name}</strong> has joined <strong>SomaWellness</strong> using your referral link.</p>
