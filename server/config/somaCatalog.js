...
// Explicit pay-ahead totals (VAT-inclusive, already discounted).
// AMANI 6/12 match the Six-Month / Annual Pass offerings on the Services page.
...
export const TRIAL = {
  ...
  SINGLE_CLASS: { label: 'Single class', price: 2000 },
};
...
export const CLASS_PASSES = {
  ...
  TEN:   { label: '10 classes', classes: 10, perClass: 1150, price: 11500, expiryMonths: 3 },
};
...
export const ACADEMY = {
  ...
  SOMA200:     { label: 'SOMA 200 Yoga Teacher Training', hours: 200, price: 130000 },
};
export const CORPORATE = {
  SINGLE: { label: 'SOMA Work Well – Single', durationMin: 60, paxMax: 20, price: 13500, bookable: true },
  MONTHLY: { label: 'SOMA Work Well – Monthly', sessions: 4, price: 45000, bookable: true },
};
...
// Canonical 17-item public catalog — same names/prices as Offerings.
// Used by syncOfficialServices + seedDefaultServices so admin,
// reception and chatbot always match the public Services page.
export const SOMA_SERVICES = PUBLIC_CATALOG.map(toServiceDoc);

// Legacy / retired names removed by sync (never reintroduced).
export const LEGACY_SERVICE_NAMES = RETIRED_SERVICE_NAMES;
